...
# Unconmment this one bellow to get email sent into stdout
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# Use this one bellow with Nodejs maildev or somethings like that
...
SECRET_KEY = 'django-insecure-1hb_))o+27^(l*v7c_k#mhdvo2shf8$v&d2s-7#37e!nfdw+f%'
